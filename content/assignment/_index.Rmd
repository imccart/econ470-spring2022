...
## Homework
Please submit all of your homework answers as a PDF through **Canvas**. You can use Word and "print" to PDF, but I also encourage you to use RMarkdown or [Overleaf](https://www.overleaf.com/), either of which will help you to easily create PDFs and is much better for writing math-oriented documents. Overleaf is also fully cloud-based, and as an Emory student, you have full access to Overleaf Professional. RMarkdown via our AWS access is also cloud-based.
