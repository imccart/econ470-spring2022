...
```{r}
knitr::include_url("https://imccart.github.io/econ470-content/02-smoking/02-smoking.html")
```


<p><a class="btn btn-primary btn-lg" target="_blank" href="https://imccart.github.io/econ470-content/02-smoking/02-smoking.html"><i class="fas fa-external-link-alt"></i> View all slides in new window</a> <a class="btn btn-primary btn-lg" target="_blank" href="https://imccart.github.io/econ470-content/02-smoking/02-smoking.pdf" role="button"><i class="far fa-file-pdf"></i> Download PDF of all slides</a></p>
